...
namespace WebAdaptive.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public AuthController(IAuthService authService, IUserService userService, ILogger<UserModel> logger)
        {
        ...
        public async Task<ActionResult> Login(UserModel userModel)
        {
            try
            {
                ...
                _logger.LogInformation("User {Username} logged in at {Time}", userModel.Email, DateTime.Now);
